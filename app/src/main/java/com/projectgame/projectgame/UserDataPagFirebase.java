...
public class UserDataPagFirebase extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // LAYOUT
        setContentView(R.layout.activity_userdata_pag_firebase);
        ...
        buttonVolver.setOnClickListener(v -> {
            Intent intent = new Intent(UserDataPagFirebase.this, ThirdPag.class);
        ...
        fusedLocationProviderClient.requestLocationUpdates(locationRequest, new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult locationResult) {
                ...
                if (location != null) {
                    ...
                    Toast.makeText(UserDataPagFirebase.this, udp_not_location, Toast.LENGTH_SHORT).show();
                }
            }
        }, getMainLooper());
    }
